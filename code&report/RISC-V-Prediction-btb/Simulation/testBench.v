...
//////////////////////////////////////////////////////////////////////////////////
//`define DataRamContentLoadPath "E:\\RISC-V\\RISC-V-Prediction-btb\\Simulation\\SimFiles\\3testAll.data"
//`define InstRamContentLoadPath "E:\\RISC-V\\RISC-V-Prediction-btb\\Simulation\\SimFiles\\3testAll.inst"
//`define DataRamContentLoadPath "E:\\RISC-V\\RISC-V-Prediction-btb\\Simulation\\SimFiles\\Number2Ascii.data"
//`define InstRamContentLoadPath "E:\\RISC-V\\RISC-V-Prediction-btb\\Simulation\\SimFiles\\Number2Ascii.inst"
//`define DataRamContentLoadPath "E:\\RISC-V\\RISC-V-Prediction-btb\\Simulation\\SimFiles\\Fibonacci.data"
//`define InstRamContentLoadPath "E:\\RISC-V\\RISC-V-Prediction-btb\\Simulation\\SimFiles\\Fibonacci.inst"
`define DataRamContentLoadPath "E:\\RISC-V\\RISC-V-Prediction-btb\\Simulation\\SimFiles\\btb.data"
`define InstRamContentLoadPath "E:\\RISC-V\\RISC-V-Prediction-btb\\Simulation\\SimFiles\\btb.inst"
`define DataRamContentSavePath "E:\\RISC-V\\RISC-V-Prediction-btb\\Simulation\\SimFiles\\DataRamContent.txt"
`define InstRamContentSavePath "E:\\RISC-V\\RISC-V-Prediction-btb\\Simulation\\SimFiles\\InstRamContent.txt"
